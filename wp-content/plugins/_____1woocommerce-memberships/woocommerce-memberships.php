...
-Null24.Net * Plugin URI: http://www.woothemes.com/products/woocommerce-memberships/
...
class WC_Memberships extends SV_WC_Plugin {
	...
	private function integration_includes() {
		...
		if ( $this->is_subscriptions_active() ) {
			$this->subscriptions = $this->load_class( '/includes/integrations/class-wc-memberships-integration-subscriptions.php', 'WC_Memberships_Integration_Subscriptions' );
		}
